...
app/                    --> all of the source files for the application
  ...
  twitterTarget/                --> the twitterTarget view template and logic
    twitterTarget.html            --> the partial template
    twitterTarget.js              --> the controller logic
    twitterTarget_test.js         --> tests of the controller
  twitterTarget/                --> the twitterTarget view template and logic
    twitterTarget.html            --> the partial template
    twitterTarget.js              --> the controller logic
    twitterTarget_test.js         --> tests of the controller
